...
class OptTester:
    ...
    def __init__(self, optimizer, name = "",
                 compute_additionals = lambda x : default_compute_additionals, dec = lambda x: unitCubeProj(x), enc = lambda x : x):
        '''
        ...
        def compute_additionals(grad = None, value = None, state = None, lossfn = None, **args):
            ... ...
